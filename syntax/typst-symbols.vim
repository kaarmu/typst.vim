...
for typmath in s:typstSubList
    exe "syn match typstMathScripts '\\S\\@=_".typmath[0]."' contained conceal cchar=".typmath[1]
endfor
...
for typmath in s:typstSupList
    exe "syn match typstMathScripts '\\S\\@=\\^".typmath[0]."' contained conceal cchar=".typmath[1]
endfor
